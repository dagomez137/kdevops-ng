# test:
# flow/f/usertests/run
# script/f/usertests/*
# SPDX-License-Identifier: copyleft-next-0.3.1
"""Deploy-time selfcheck for the usertests run flow (a Windmill CI test).

The `# test:` annotation makes Windmill run this script whenever the run
flow or any `f/usertests` script deploys; it drives the deployed collect,
...
def main() -> dict:
    return selfcheck.check("usertests", "per_item", "item")
