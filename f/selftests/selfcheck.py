# test:
# flow/f/selftests/run
# script/f/selftests/*
# SPDX-License-Identifier: copyleft-next-0.3.1
"""Deploy-time selfcheck for the kselftest run flow (a Windmill CI test).

The `# test:` annotation makes Windmill run this script whenever the run
flow or any `f/selftests` script deploys; it drives the deployed collect,
...
def main() -> dict:
    return selfcheck.check("selftests", "per_item", "item")
