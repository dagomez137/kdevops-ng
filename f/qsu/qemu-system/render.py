...
def main(
    ...
    kernel_initrd: str = "",
    kernel_append: str = "",
    kernel_parameters: list | None = None,
    extra_kernel_parameters: str = "",
    extra_qemu_args: str = "",
    modules_dir: str = "",
    ...
    # the BlockConf sizes, unmap on discard, ioeventfd and mdts off QEMU's own
    # defaults (the schema says why), the rest empty/false. See NVME_*_KNOBS in
    # f/qsu/common.
    ...
    vm_name = resolve_vm_name({"auto_vm_name": auto_vm_name, "vm_name": vm_name})
        ...
        "kernel_parameters": kernel_parameters or None,
        "extra_kernel_parameters": extra_kernel_parameters or None,
        "extra_qemu_args": extra_qemu_args or None,
        ...
        "nvme_drive_size_gb": nvme_drive_size_gb,
        ...
        "aio": aio,
        "cache": cache,
        "aio_max_batch": aio_max_batch,
        "read_zeroes": read_zeroes,
