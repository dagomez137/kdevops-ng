...
def main(
    ...
    vm_index: int = 0,
    iommu: str = "",
    # PCI passthrough: only threaded into the vars; the vendored templates own
    # the -device line, the vfio-bind@ dependency and the hardening entries.
    pci_passthrough_addrs: str = "",
    pci_passthrough_opts: str = "",
    qemu_source: str = "nixpkgs",
    qemu_binary: str = "",
    ...
    vm_name = resolve_vm_name({"auto_vm_name": auto_vm_name, "vm_name": vm_name})
        ...
        "iommu": iommu or None,
        "pci_passthrough_addrs": pci_passthrough_addrs,
        "pci_passthrough_opts": pci_passthrough_opts,
