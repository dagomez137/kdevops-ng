# test:
# flow/f/fstests/check
# script/f/fstests/*
# SPDX-License-Identifier: copyleft-next-0.3.1
"""Deploy-time selfcheck for the xfstests check flow (a Windmill CI test).

The `# test:` annotation makes Windmill run this script whenever the check
flow or any `f/fstests` script deploys; it drives the deployed collect,
...
def main() -> dict:
    return selfcheck.check("fstests", "per_section", "section")
